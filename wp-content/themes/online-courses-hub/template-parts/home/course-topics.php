 ...
 */
?>
<?php if( get_theme_mod( 'online_courses_hub_course_enable') != '') { ?>
<?php if( get_theme_mod('online_courses_hub_course_fields_number') != ''){ ?>
<section id="course-fields">
    <div class="owl-carousel">
        <?php $online_courses_hub_number = get_theme_mod('online_courses_hub_course_fields_number');
        for($i=1; $i<=$online_courses_hub_number; $i++ ) { ?>
