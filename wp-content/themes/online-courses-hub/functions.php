...
function online_courses_hub_enqueue_styles() {
    ...
    require get_theme_file_path( '/tp-theme-color.php' );
        wp_add_inline_style( 'online-courses-hub-child-style',$elearning_education_tp_theme_css );
...
function online_courses_hub_header_style() {
    if ( get_header_image() ) :
    $elearning_education_custom_header = "
        .headerbox{
            background-image:url('".esc_url(get_header_image())."');
            background-position: center top;
            background-size: cover;
        }";
        wp_add_inline_style( 'online-courses-hub-child-style', $elearning_education_custom_header );
    endif;
}
...
define('ONLINE_COURSES_HUB_CREDIT',__('https://www.themespride.com/products/free-courses-wordpress-theme','online-courses-hub') );
if ( ! function_exists( 'online_courses_hub_credit' ) ) {
    function online_courses_hub_credit(){
        echo "<a href=".esc_url(ONLINE_COURSES_HUB_CREDIT)." target='_blank'>".esc_html__(get_theme_mod('elearning_education_footer_text',__('Online Courses WordPress Theme','online-courses-hub')))."</a>";
    }
}

if ( ! defined( 'ELEARNING_EDUCATION_PRO_THEME_URL' ) ) {
    define( 'ELEARNING_EDUCATION_PRO_THEME_URL', 'https://www.themespride.com/products/online-courses-wordpress-theme' );
}
...
if ( ! defined( 'ELEARNING_EDUCATION_FREE_THEME_URL' ) ) {
    define( 'ELEARNING_EDUCATION_FREE_THEME_URL', 'https://www.themespride.com/products/free-courses-wordpress-theme' );
}
if ( ! defined( 'ELEARNING_EDUCATION_DEMO_THEME_URL' ) ) {
    define( 'ELEARNING_EDUCATION_DEMO_THEME_URL', 'https://page.themespride.com/online-courses-pro/' );
}
if ( ! defined( 'ELEARNING_EDUCATION_DOCS_THEME_URL' ) ) {
    define( 'ELEARNING_EDUCATION_DOCS_THEME_URL', 'https://page.themespride.com/demo/docs/online-courses-hub-lite/' );
}
if ( ! defined( 'ELEARNING_EDUCATION_DOCS_URL' ) ) {
    define( 'ELEARNING_EDUCATION_DOCS_URL', 'https://page.themespride.com/demo/docs/online-courses-hub-lite/' );
}
