                            ...
                            <div class="form-group row" style="padding:5px;">
                                <div class="col-sm-4">
                                    <label for="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-chat-temprature">
                                        <?php echo __( "Temperature", "ays-chatgpt-assistant" ); ?>
                    ...
                    <div id="tab2" class="<?php echo esc_attr(CHATGPT_ASSISTANT_CLASS_PREFIX); ?>-tab-content ays-tab-content <?php echo ($ays_tab == 'tab2') ? 'ays-tab-content-active' : ''; ?>">
                        ...
                        <hr />
                            ...
                            <div class="form-group row" style="padding:5px;">
                                <div class="col-sm-4">
                                    <label for="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-chatbot-border-radius">
                                        <?php echo __( "Send message icon", "ays-chatgpt-assistant" ); ?>
                                        <a class="ays_help" data-bs-toggle="tooltip" title="<?php echo __("Add your custom chat icon to the chatbot send message button.", "ays-chatgpt-assistant")?>">
                                            <img src="<?php echo esc_attr(CHATGPT_ASSISTANT_ADMIN_URL); ?>/images/icons/info-circle.svg">
                                        </a>
                                    </label>
                                </div>
                                <div class="col-sm-8 <?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-image-container ays_divider_left">
                                    <button id="<?php echo CHATGPT_ASSISTANT_ID_PREFIX; ?>-send-message-icon" class="button <?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-add-send-message-icon" type="button"><?php echo $this->chatgpt_assistant_send_message_icon_text; ?></button>
                                    <div class="<?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-image-body" style="<?php echo $this->chatgpt_assistant_send_message_icon != '' ? '' : 'display: none;'; ?>">
                                        <div class="<?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-image-wrapper">
                                            <div class="<?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-image-wrapper-delete-wrap">
                                                <div role="button" class="<?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-image-wrapper-delete-cont <?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-logo-remove <?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>remove-image">
                                                    <div class="<?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-icons">
                                                        <img src="<?php echo CHATGPT_ASSISTANT_ADMIN_URL; ?>/images/icons/close-grey.svg">
                                                    </div>
                                                </div>
                                            </div>
                                            <img class="<?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-img" src="<?php echo $this->chatgpt_assistant_send_message_icon; ?>" />
                                            <input type="hidden" name="<?php echo esc_attr(CHATGPT_ASSISTANT_NAME_PREFIX); ?>_send_message_icon" class="<?php echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-img-src" value="<?php echo $this->chatgpt_assistant_send_message_icon; ?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="padding:5px;">
                                <div class="col-sm-4">
                                    <label for="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-send-message-text">
                                        <?php echo __( "Send message button text", "ays-chatgpt-assistant" ); ?>
                                        <a class="ays_help" data-bs-toggle="tooltip" title="<?php echo __("Specify custom text for the chatbot send button. Leave blank to show the icon instead.","ays-chatgpt-assistant")?>">
                                            <img src="<?php echo esc_attr(CHATGPT_ASSISTANT_ADMIN_URL); ?>/images/icons/info-circle.svg">
                                        </a>
                                    </label>
                                </div>
                                <div class="col-sm-8">
                                    <textarea name="<?php echo esc_attr(CHATGPT_ASSISTANT_NAME_PREFIX); ?>_send_message_text" class="<?php echo esc_attr(CHATGPT_ASSISTANT_CLASS_PREFIX); ?>-send-message-text" placeholder="" style="height:<?php echo $textarea_height?>px"><?php echo esc_attr($this->chatgpt_assistant_send_message_text); ?></textarea>
                                </div>
                            </div>
                            <!-- Send button font size -->
                            <div class="form-group row" style="padding:5px;">
                                <div class="col-sm-4">
                                    <label for="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-send-button-font-size">
                                        <?php echo __( "Send Button Font Size", "ays-chatgpt-assistant" ); ?>
                                        <a class="ays_help" data-bs-toggle="tooltip" title="<?php echo __("Specify the font size for chat send button text.", "ays-chatgpt-assistant")?>">
                                            <img src="<?php echo esc_attr(CHATGPT_ASSISTANT_ADMIN_URL); ?>/images/icons/info-circle.svg">
                                        </a>
                                    </label>
                                </div>
                                <div class="col-sm-8 d-flex">
                                    <div>
                                        <input type="number" class="ays-text-input ays-text-input-short" name="<?php echo esc_attr(CHATGPT_ASSISTANT_NAME_PREFIX); ?>_send_button_font_size" id="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-send-button-font-size" value="<?php echo esc_attr($this->chatgpt_assistant_send_button_font_size);?>">
                                    </div>
                                    <div class="<?php echo esc_attr(CHATGPT_ASSISTANT_CLASS_PREFIX); ?>-hint-box">
                                        <input type="text" value="px" class="<?php echo esc_attr(CHATGPT_ASSISTANT_CLASS_PREFIX); ?>-hint-input" disabled>
                                    </div>
                            ...
                            <div class="form-group row" style="padding:5px;">
                                <div class="col-sm-4">
                                    <label for="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-send-button-padding">
                                        <?php echo __( "Send Button Padding", "ays-chatgpt-assistant" ); ?>
                                        <a class="ays_help" data-bs-toggle="tooltip" title="<?php echo __("Specify the padding for chat send button text.", "ays-chatgpt-assistant")?>">
                                            <img src="<?php echo esc_attr(CHATGPT_ASSISTANT_ADMIN_URL); ?>/images/icons/info-circle.svg">
                                        </a>
                                    </label>
                                </div>
                                <div class="col-sm-8 d-flex">
                                    <div>
                                        <input type="number" class="ays-text-input ays-text-input-short" name="<?php echo esc_attr(CHATGPT_ASSISTANT_NAME_PREFIX); ?>_send_button_padding" id="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-send-button-padding" value="<?php echo esc_attr($this->chatgpt_assistant_send_button_padding);?>">
                                    </div>
                                    <div class="<?php echo esc_attr(CHATGPT_ASSISTANT_CLASS_PREFIX); ?>-hint-box">
                                        <input type="text" value="px" class="<?php echo esc_attr(CHATGPT_ASSISTANT_CLASS_PREFIX); ?>-hint-input" disabled>
                                    </div>
                            ...
                            <!-- === END CHAT STYLES START === -->
                            <hr>
                                    <p class="ays-subtitle"><?php echo __('End chat modal styles' , "ays-chatgpt-assistant")?></p>
                                <hr>
                                <!-- Button background color -->
                                <div class="form-group row" style="padding:5px;">
                                    <div class="col-sm-4">
                                        <label for="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-end-chat-button-bg-color">
                                            <?php echo __( "Button background color", "ays-chatgpt-assistant" ); ?>
                                            <a class="ays_help" data-bs-toggle="tooltip" title="<?php echo __("Specify the background color of the end chat button.", "ays-chatgpt-assistant")?>">
                                                <img src="<?php echo esc_attr(CHATGPT_ASSISTANT_ADMIN_URL); ?>/images/icons/info-circle.svg">
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="color" name="<?php echo esc_attr(CHATGPT_ASSISTANT_NAME_PREFIX); ?>_end_chat_button_bg_color" id="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-end-chat-button-bg-color" value="<?php echo $this->chatgpt_assistant_end_chat_button_bg_color;?>">
                                    </div>
                                </div> 
                                <hr>
                                <!-- Button text color -->
                                <div class="form-group row" style="padding:5px;">
                                    <div class="col-sm-4">
                                        <label for="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-end-chat-button-text-color">
                                            <?php echo __( "Button text color", "ays-chatgpt-assistant" ); ?>
                                            <a class="ays_help" data-bs-toggle="tooltip" title="<?php echo __("Specify the text color of the end chat button.", "ays-chatgpt-assistant")?>">
                                                <img src="<?php echo esc_attr(CHATGPT_ASSISTANT_ADMIN_URL); ?>/images/icons/info-circle.svg">
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <input type="color" name="<?php echo esc_attr(CHATGPT_ASSISTANT_NAME_PREFIX); ?>_end_chat_button_text_color" id="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-end-chat-button-text-color" value="<?php echo $this->chatgpt_assistant_end_chat_button_text_color;?>">
                                    </div>
                                </div> 
                                <hr>
                                ...
                                <div class="form-group row" style="padding:5px;">
                                    <div class="col-sm-4">
                                        <label for="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-end-chat-button-text-font-size">
                                            <?php echo __( "Button text font size", "ays-chatgpt-assistant" ); ?>
                                            <a class="ays_help" data-bs-toggle="tooltip" title="<?php echo __("Specify font size of the end chat button text.", "ays-chatgpt-assistant")?>">
                                                <img src="<?php echo esc_attr(CHATGPT_ASSISTANT_ADMIN_URL); ?>/images/icons/info-circle.svg">
                                            </a>
                                        </label>
                                    </div>
                                    <div class="col-sm-8 d-flex">
                                        <div>
                                            <input type="number" class="ays-text-input ays-text-input-short" name="<?php echo esc_attr(CHATGPT_ASSISTANT_NAME_PREFIX); ?>_end_chat_button_text_font_size" id="<?php echo esc_attr(CHATGPT_ASSISTANT_ID_PREFIX); ?>-end-chat-button-text-font-size" value="<?php echo esc_attr($this->chatgpt_assistant_end_chat_button_text_font_size);?>">
                                        </div>
                                        <div class="<?php echo esc_attr(CHATGPT_ASSISTANT_CLASS_PREFIX); ?>-hint-box">
                                            <input type="text" value="px" class="<?php echo esc_attr(CHATGPT_ASSISTANT_CLASS_PREFIX); ?>-hint-input" disabled>
                                        </div>
