<?php
    ...
    $chatgpt_assistant_icon_text_logged_in = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_logged_in'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_logged_in'] != '' ) ? stripslashes(sanitize_text_field($options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_logged_in'])) : $chatgpt_assistant_icon_text;
    ...
    $chatgpt_assistant_icon_text_letter_spacing = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_letter_spacing'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_letter_spacing'] != '' ) ? stripslashes(sanitize_text_field($options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_letter_spacing'])) : 0;
    ...
    $chatgpt_assistant_icon_text_border_radius = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_border_radius'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_border_radius'] != '' ) ? absint(stripslashes(sanitize_text_field($options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_border_radius']))) : 10;
    $chatgpt_assistant_icon_text_padding = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_padding'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_padding'] != '' ) ? absint(stripslashes(sanitize_text_field($options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_padding']))) : 5;
    ...
    $chatgpt_assistant_icon_text_scroll_open = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_scroll_open'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_scroll_open'] != '' ) ? absint(stripslashes(sanitize_text_field($options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_scroll_open']))) : 0;
    ...
    $chatgpt_assistant_icon_text_close_button = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_close_button'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_close_button'] == 'on' ) ? true : false;
    $chatgpt_assistant_icon_text_open_on_click = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_open_on_click'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'icon_text_open_on_click'] == 'off' ) ? false : true;
    ...
    $chatgpt_assistant_token_guest_limitations_limit = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_guest_limitations_limit'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_guest_limitations_limit'] != '' ) ? absint($options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_guest_limitations_limit']) : 0;

    $chatgpt_assistant_token_guest_limitations_interval = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_guest_limitations_interval'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_guest_limitations_interval'] != '' ) ? sanitize_text_field($options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_guest_limitations_interval']) : 'day';

    $chatgpt_assistant_token_login_limitations_limit = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_login_limitations_limit'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_login_limitations_limit'] != '' ) ? absint($options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_login_limitations_limit']) : 0;

    $chatgpt_assistant_token_login_limitations_interval = ( isset( $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_login_limitations_interval'] ) && $options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_login_limitations_interval'] != '' ) ? sanitize_text_field($options[CHATGPT_ASSISTANT_OPTIONS_PREFIX.'token_login_limitations_interval']) : 'day';
