...
<div class="wrap">
    <div class="container-fluid">
        <form method="post" id="ays-rates-form">
            <!-- <input type="hidden" name="ays_tab" value="<?php // echo $ays_tab; ?>"> -->
            <h1 class="wp-heading-inline">
            <?php
                echo __('Rates',$this->plugin_name);
            ?>
            </h1>
            <hr>
                ...
                <!-- <div class="<?php // echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-settings-nav-tab">
                    <div class="<?php // echo CHATGPT_ASSISTANT_CLASS_PREFIX; ?>-nav-tab-wrapper" style="position:sticky; top:35px;">
                        <a href="#tab1" data-tab="tab1" class="nav-tab <?php // echo ($ays_tab == 'tab1') ? 'nav-tab-active' : ''; ?>">
                            <?php // echo __("Rates", $this->plugin_name);?>
                        </a>
                    </div>
                </div> -->
                            ...
                            <div id="post-body" class="metabox-holder">
                                <div id="post-body-content">
                                    <div class="meta-box-sortables ui-sortable">
                                        <!-- <form method="post"> -->
                                            <?php
                                                $this->rates_table_obj->prepare_items();
                                                $this->rates_table_obj->display();
                                            ?>
                                        <!-- </form> -->
                                    </div>
                                </div>
            ...
            <!-- <div style="position:sticky;padding:15px 0px;bottom:0;">
                <?php
                    // wp_nonce_field('rates_action', 'rates_action');
                    // $other_attributes = array();
                    // submit_button(__('Save changes', $this->plugin_name), 'primary', 'ays_submit', true);
                    // echo $loader_image;
                ?>
            </div> -->
        </form>
